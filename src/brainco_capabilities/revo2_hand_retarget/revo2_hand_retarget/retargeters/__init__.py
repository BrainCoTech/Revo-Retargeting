...
class BaseRetargeter(ABC):
    ...
    def retarget_process(
        ...
        left_joint_positions: dict | None = None,
        right_joint_positions: dict | None = None,
        ...
        Args:
            ...
            left_joint_positions: Canonical left hand angles keyed by semantic name.
            right_joint_positions: Canonical right hand angles keyed by semantic name.
...
_import_builtin(
    "joint_thumb",
    "revo2_hand_retarget.retargeters.joint_thumb_retargeter",
)
