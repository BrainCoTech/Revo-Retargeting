...
def _create_actions(context: LaunchContext, *args, **kwargs):
    ...
    actions = [
        LogInfo(
            msg=(
                "Starting source-neutral Revo2 real-hand pipeline: "
    ...
    if launch_retarget:
        actions.append(
            TimerAction(
                ...
                actions=[
                    LogInfo(msg="Starting canonical Revo2 hand-retarget node."),
                    IncludeLaunchDescription(
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "retarget_delay",
            default_value="18.0",
            description="Seconds to wait before starting the hand retargeter.",
        ),
        DeclareLaunchArgument(
            "plot_delay",
            default_value="19.0",
        ...
        DeclareLaunchArgument(
            "launch_retarget",
            default_value="true",
            description="Start the source-neutral hand retarget pipeline.",
        ),
        DeclareLaunchArgument(
            "launch_plot",
            default_value="true",
        ...
        DeclareLaunchArgument(
            ...
            description="Revo2 hand-retarget runtime YAML.",
        ),
        DeclareLaunchArgument(
