...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', [
            ...
            'launch/humandex_real_hand_pipeline_launch.py',
        ]),
        ('share/' + package_name + '/tools', [
            'tools/analyze_revo2_jitter_bag.py',
            'tools/humandex_replay_bridge.py',
            'tools/play_humandex_raw.sh',
            'tools/record_humandex_raw.sh',
            'tools/record_humandex_teleop.sh',
